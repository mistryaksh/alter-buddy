...
import { SignInInitialState, SignInValidationSchema } from "../../../validation";
...
export const SignInBody: FC<SignInBodyProps> = ({ viewSwitcher, loginFunc, error, loading }) => {
     return (
          <div className="flex flex-col items-center gap-5 mx-auto w-[60%]">
               ...
               >
                    ...
                    <Formik
                         ...
                         onSubmit={loginFunc}
                    >
                         {({ errors, values, handleBlur, touched, handleChange, handleSubmit }) => (
