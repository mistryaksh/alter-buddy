...
const MentorAuthenticationApi = createApi({
     ...
     endpoints: ({ mutation, query }) => ({
          MentorSignIn: mutation<{ data: { message: string; token: string; user: IMentorAuthProps } }, any>({
...
export const MentorAuthenticationApiMiddleware = MentorAuthenticationApi.middleware;
export const MentorAuthenticationApiReducer = MentorAuthenticationApi.reducer;
export const { useMentorProfileQuery, useMentorSignInMutation } = MentorAuthenticationApi;
