  ...
  return (
    <MainLayout loading={isSubCategoryLoading || isFaqLoading}>
      ...
      <div className="bg-primary-200 py-20 pb-28">
        <div className="container mx-auto grid justify-center grid-col-12 xl:grid-cols-4 lg:grid-cols-4 gap-10 md:col-span-12">
          {mentor?.data
      ...
      <div className="w-[80%] p-3 mx-auto my-20">
        ...
        <ul className="flex flex-wrap items-start gap-20 mt-10">
