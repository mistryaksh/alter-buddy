          ...
          <div className="flex flex-wrap-reverse items-center gap-10">
            <div className="flex-1 flex flex-col gap-3">
              ...
              <p className="text-gray-500">
                Feeling lonely, anxious? Relationship problems? Let us help you
                in your healing process. Find Top Mental Health experts here.
                Start your first free chat
              </p>
            </div>
            <img
        ...
        <div className="py-20 container mx-auto">
          <div className="flex gap-10 flex-wrap">
            ...
            {subCategory?.data.map(({ label, _id }) => (
              ...
              >
                <p className="capitalize group-hover:text-primary-500">
                  {label}
                </p>
              </div>
            ))}
          ...
          {mentor?.data.length === 0 && (
            <div className="">
              ...
              <p>
                ...
                ipsum dolor sit amet, consectetur adipisicing elit. Ut incidunt
                enim esse suscipit amet sint facere ipsam voluptatem
