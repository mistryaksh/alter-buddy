...
const MentorMeetingView: FC<MentorMeetingViewProps> = ({
  userName,
  callerName,
  mentorId,
  userId,
          ...
          <div className="flex flex-col gap-3">
            <div>
              <h6 className="text-2xl">
                ...
                is waiting for you in session
              </h6>
              <p>
                You are notified by this user for consultations, please click
                further to join session
              </p>
            </div>
      ...
      {itsMe && (
        <div className="flex items-center gap-5 bg-primary-500 rounded-lg text-white p-3">
          <p className="capitalize">
            {!itsMe ? displayName : `Your Preferences`}{" "}
          </p>
